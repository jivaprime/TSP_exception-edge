...
> 
> 이 솔버는 **사전학습(pretraining) 없이**, 목표 인스턴스에서의 rollout만으로 정책을 처음부터 학습합니다.
> 외부 데이터셋, 합성 데이터, 또는 LKH 솔루션을 사용하지 않습니다.
> 
> d1291에서 1.66% gap은 **사전학습 기반 모델들(RsGCN 0.14%, DRHG 2.09% 등)과 경쟁할 수 있는 수준**이며,
> 순수 zero-shot 방식으로는 최고 수준의 결과입니다.

> **Benchmark 출처**
> - ML baseline 비교: [RsGCN (arXiv:2506.00533)](https://arxiv.org/abs/2506.00533)
